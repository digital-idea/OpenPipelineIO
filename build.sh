...
# 디지털아이디어 빌드
GOOS=linux GOARCH=amd64 go build -ldflags "-X main.COMPANY=digitalidea -X main.MAILDNS=idea.co.kr -X main.TEMPLATEPATH=template -X main.DBIP=10.0.90.251 -X main.DILOG=http://10.0.90.251:8080 -X main.WFS=http://10.0.98.20:8081 -X main.THUMBPATH=/lustre/INHouse/Tool/csidata/thumbnail -X main.MEDIAPATH=/lustre/INHouse/Tool/csi3/media -X main.TEMPLATEPATH=/lustre/INHouse/Tool/csi3/template" -o ./bin/linux_di/${APP} camera.go check.go cmdfunc.go crypto.go csi3.go db_item.go db_project.go db_setellite.go db_user.go http_api.go http_cmd.go http_item.go http_project.go http_setellite.go http_user.go http.go item.go log.go network.go parser.go project.go searchop.go setellite.go setellitefunc.go templatefunc.go usage.go user.go timefunc.go assets_vfsdata.go
GOOS=darwin GOARCH=amd64 go build -ldflags "-X main.COMPANY=digitalidea -X main.MAILDNS=idea.co.kr -X main.TEMPLATEPATH=template -X main.DBIP=10.0.90.251 -X main.DILOG=http://10.0.90.251:8080 -X main.WFS=http://10.0.98.20:8081 -X main.THUMBPATH=/lustre/INHouse/Tool/csidata/thumbnail -X main.MEDIAPATH=/lustre/INHouse/Tool/csi3/media -X main.TEMPLATEPATH=/lustre/INHouse/Tool/csi3/template" -o ./bin/darwin_di/${APP} camera.go check.go cmdfunc.go crypto.go csi3.go db_item.go db_project.go db_setellite.go db_user.go http_api.go http_cmd.go http_item.go http_project.go http_setellite.go http_user.go http.go item.go log.go network.go parser.go project.go searchop.go setellite.go setellitefunc.go templatefunc.go usage.go user.go timefunc.go assets_vfsdata.go
#GOOS=windows GOARCH=amd64 go build -ldflags "-X main.COMPANY=digitalidea -X main.MAILDNS=idea.co.kr -X main.TEMPLATEPATH=template -X main.DBIP=10.0.90.251 -X main.DILOG=http://10.0.90.251:8080 -X main.WFS=http://10.0.98.20:8081 -X main.THUMBPATH=/lustre/INHouse/Tool/csidata/thumbnail -X main.MEDIAPATH=/lustre/INHouse/Tool/csi3/media -X main.TEMPLATEPATH=/lustre/INHouse/Tool/csi3/template" -o ./bin/windows_di/${APP}.exe camera.go check.go cmdfunc.go crypto.go csi3.go db_item.go db_project.go db_setellite.go db_user.go http_api.go http_cmd.go http_item.go http_project.go http_setellite.go http_user.go http.go item.go log.go network.go parser.go project.go searchop.go setellite.go setellitefunc.go templatefunc.go usage.go user.go timefunc.go assets_vfsdata.go
