...
| /api1/statistics/pipelinestep | status V1 pipelinestep의 샹태를 가지고옵니다. 프로젝트 옵션이 있다면 해당 프로젝트 갯수를 처리합니다. | pipelinestep, task,(project),type | curl -H "Authorization: Basic {TOKEN}" "https://csi.lazypic.com/api1/statistics/task?project=TEMP&task=roto&type=shot&pipelinestep=comp"
...
| /api2/statistics/pipelinestep | status V2 pipelinestep 샹태를 가지고옵니다. 프로젝트 옵션이 있다면 해당 프로젝트 갯수를 처리합니다. | pipelinestep,task,(project),type | curl -H "Authorization: Basic {TOKEN}" "https://csi.lazypic.com/api2/statistics/task?project=TEMP&pipelinestep=comp&task=roto&type=shot"
