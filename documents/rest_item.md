...
| /api/rmpublish | Publish 를 삭제한다. | project, id, task, key, createtime | `$ curl -X POST -H "Authorization: Basic <Token>" -d "project=TEMP&id=SS_0010_org&task=comp&key=pub&createtime=2020-05-21T09:00:00%2B09:00" https://csi.lazypic.org/api/rmpublish`|
