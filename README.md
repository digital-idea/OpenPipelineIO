...
### Roadmap
- [ ] 1. 사용자별 샷 갯수, 리스트가 나오도록 처리하기. -> items 컬렉션을 통합하기
- [ ] 2. 3D 파이프라인에 추가적으로 필요한 자료구조 및 API 생성(샷트레킹, 버전, 퍼블리쉬) with USD
- [ ] 3. Status를 유연하게 바꿀 수 있도록 기능변경
- [ ] 4. 통계툴을 내부에서 일괄 처리하도록 통합(기존 Statistics 서비스 통합) - 1번이 완료되어야 가능
- [ ] 5. 전문적인 리뷰툴 추가(현재 웹프로토콜 + RV)
- [ ] 6. 파트너 관리툴 추가
- [ ] 7. 프로젝트에 사용하는 소프트웨어 등록, 환경변수 관리 -> JWT토큰으로 dilink 연동
- [ ] 8. 웹 스캔 툴: ACES2065-1(또는 사용자 설정) > ACEScg 
- [ ] 9. 캘린더 연동: https://github.com/lazypic/kalena
- [ ] 10. 도토리 연동: https://github.com/rd101/dotori
