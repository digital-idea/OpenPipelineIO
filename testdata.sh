openpipelineio -add project -name TEMP
openpipelineio -add project -name circle

# set asset mov
openpipelineio -add item -type asset -name mamma -project TEMP -assettype char -assettags char,component
...
# set shot mov
openpipelineio -add item -type org -name SS_0010 -project TEMP
