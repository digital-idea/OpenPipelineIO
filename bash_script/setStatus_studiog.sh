...
curl -X POST -H "Authorization: Basic $Token" -d "id=retake&description=retake&textcolor=#FFFFFF&bgcolor=#FF0000&bordercolor=#FF0000&order=8&defaulton=false" "http://localhost/api/addstatus"
