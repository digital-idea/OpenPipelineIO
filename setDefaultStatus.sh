...
curl -X POST -H "Authorization: Basic $Token" -d "id=assign&description=assign&textcolor=#000000&bgcolor=#FFF76B&bordercolor=#FFF76B&order=4&defaulton=true&initstatus=true" "http://localhost/api/addstatus"
